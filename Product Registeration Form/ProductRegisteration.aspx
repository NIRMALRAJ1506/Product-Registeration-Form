<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegisteration.aspx.cs" Inherits="Product_Registeration_Form.ProductRegisteration" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td colspan="3">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Image/dell laptop.jpg" />
                    </td>
                </tr>
                <tr>
